...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('happyGifContainer')
      .style.display = 'block';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        case 0:
            ...
            document.getElementById('noBtn').innerHTML = 'Oh no! Are you sure SUSU?';
        ...
        case 1:
            ...
            document.getElementById('noBtn').innerHTML = 'Are you really sure babe beacuse i will kill you 🔪?! ';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer').style.display = 'none';
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = 'Are You OK';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 4:
            ...
            document.getElementById('noBtn').innerHTML = 'Can you say yes, please?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 6:
            ...
            document.getElementById('noBtn').innerHTML = 'If you say no, I will be very sad';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 10:
            ...
            document.getElementById('noBtn').innerHTML = 'Okay, I will stop asking...';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 15:
            ...
            document.getElementById('noBtn').innerHTML = 'Pleaseeeeeeeeeeeeeeeee Babe';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 16:
                document.getElementById('noBtn').innerHTML = '';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
